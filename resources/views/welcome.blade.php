...
@section('title', 'Skillmap - Find Skilled Professionals')

@section('head')
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.css" />
<link rel="stylesheet" href="https://unpkg.com/leaflet-routing-machine@3.2.12/dist/leaflet-routing-machine.css" />
<style>
    #discover-map { height: 480px; }
...
<div class="min-h-screen bg-gradient-to-b from-blue-50 to-white">
    ...
    <div class="max-w-6xl mx-auto px-4 py-16">
        <div class="text-center">
            <h1 class="text-5xl font-bold text-gray-900 mb-4">Find Skilled Professionals</h1>
            <p class="text-xl text-gray-600 mb-8">Connect with trusted taskers for any job. Fast, reliable, and affordable.</p>

            @auth
                <div class="space-y-4">
                    <p class="text-gray-700">Welcome back, {{ auth()->user()->name }}!</p>
                    <a href="{{ route(auth()->user()->role . '.dashboard') }}" class="inline-block bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition">
            ...
            @else
                <div class="space-y-4">
                    ...
                    <div class="flex gap-4 justify-center flex-wrap">
                        ...
                        <a href="{{ route('login') }}" class="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold border-2 border-blue-600 hover:bg-blue-50 transition">
                            Sign In
                        </a>
                    </div>
                </div>
    ...
    <div class="bg-white py-16 border-t border-gray-100">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-8">
                <h2 class="text-3xl font-bold text-gray-900 mb-2">Taskers Near You</h2>
                <p class="text-gray-500">Share your location to discover skilled professionals in your area</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div class="lg:col-span-2 relative rounded-xl overflow-hidden shadow-md border border-gray-200">
                    ...
                    <!-- Overlay shown before location is shared -->
                    <div id="map-overlay"
                        class="absolute inset-0 bg-gray-900 bg-opacity-55 flex items-center justify-center">
    ...
    <div class="bg-white py-16">
        <div class="max-w-6xl mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-12">How Skillmap Works</h2>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600">Find skilled professionals near you by trade, specialization, and ratings</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600">Post job details and receive quotes from qualified professionals</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold mb-2">Rate</h3>
                    <p class="text-gray-600">Rate and review professionals to help others find the best matches</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-16">
        <div class="max-w-6xl mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-12">For Everyone</h2>

            <div class="grid md:grid-cols-2 gap-8">
                <!-- Customers -->
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-lg">
                    <h3 class="text-2xl font-bold text-blue-900 mb-4">For Customers</h3>
                    <ul class="space-y-3 text-blue-800">
                        <li class="flex items-center gap-2">
                            <span class="text-green-600">✓</span> Search professionals by location & skill
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="text-green-600">✓</span> Post job requests with detailed descriptions
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="text-green-600">✓</span> Compare quotes and prices
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="text-green-600">✓</span> Chat securely with professionals
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="text-green-600">✓</span> Save favorite professionals
                        </li>
                    </ul>
                </div>
                ...
                <div class="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-lg">
                    <h3 class="text-2xl font-bold text-green-900 mb-4">For Professionals</h3>
                    <ul class="space-y-3 text-green-800">
                        <li class="flex items-center gap-2">
                            <span class="text-green-600">✓</span> Create detailed professional profile
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="text-green-600">✓</span> Showcase skills and certifications
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="text-green-600">✓</span> Set flexible pricing & availability
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="text-green-600">✓</span> Receive job requests in your area
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="text-green-600">✓</span> Build your reputation with ratings
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="bg-blue-600 py-12">
        <div class="max-w-4xl mx-auto text-center px-4">
            ...
            <p class="text-blue-100 mb-8 text-lg">Join thousands of professionals and customers using Skillmap</p>

            @guest
                <a href="{{ route('register') }}" class="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition inline-block">
        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="grid md:grid-cols-4 gap-8 text-center">
                <div>
                    ...
                    <p class="text-gray-600">Professional Taskers</p>
                </div>
                <div>
                    <div class="text-4xl font-bold text-blue-600">1000+</div>
                    <p class="text-gray-600">Jobs Completed</p>
                </div>
                <div>
                    <div class="text-4xl font-bold text-blue-600">4.8/5</div>
    ...
    <div class="bg-gray-900 text-gray-300 py-8">
        <div class="max-w-6xl mx-auto px-4 text-center">
            <p>&copy; 2026 Skillmap. All rights reserved.</p>
            <p class="mt-2 text-sm">Laravel {{ Illuminate\Foundation\Application::VERSION }} | PHP {{ PHP_VERSION }}</p>
        </div>
    </div>
</div>
...
(function () {
    ...
    let map, userMarker;
    let allMarkers     = [];   // [{marker, tradeId}]
    let tradeColorMap  = {};   // {tradeId: colorName}
    let taskersById    = {};   // {id: tasker} — for popup onclick
    let colorIdx       = 0;
    let currentLat     = null;
    let currentLng     = null;
    ...
    function initMap() {
        map = L.map('discover-map').setView([-1.286389, 36.816667], 11);
    ...
    // Expose routeTo globally so Leaflet popup onclicks can reach it
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Drop-a-pin toggle button (controls bar)
        ...
        // Drop-a-pin button inside the overlay
